 ...
 *
 * @section Description
 * Reads an analog input on pin A0, converts it to voltage, and prints
 * the result to the serial monitor. Graphical representation is
 * available using serial plotter (Tools > Serial Plotter
 * menu).
 *
 * @section Circuit
 ...
 * Rewrite of the Arduino example sketch; 01.Basics/ReadAnalogVoltage.
 *
